<?php
/* Mensagens de erro amigáveis de bancos de dados

   Estas funçãoes devem ser chamadas por meio da função call_user_func(), para que o número do erro possa ser concatenado ao nome da função. Exemplo:
