...
<?php endif;
  ...
  <div class="container">
  	<div class="alert mt-2" style="background-color: rgb(222, 75, 75);" role="alert">
						...
						<div class="col-xm-12 col-md-6 ">
			             <div class="row">
					        ...
					        <?php
								...
								$query = 'SELECT * FROM produtos WHERE id_categoria = 1 ORDER BY id_produto ASC ';
						    ...
						    <div class="produtos">
                                        <div class="row" >
                                            ...
                                            <?php if(isset($nome)):?>
                                             <input onclick="myFunction()" id="botao_carrinho" type="submit" name="add_to_cart" value="Adicionar ao carrinho">
                                            <?php endif?>
