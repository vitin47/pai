						...
						<div class="col-xm-12 col-md-6 ">
			             <div class="row">
					        ...
					        <?php
								...
								$query = 'SELECT * FROM produtos WHERE id_categoria = 3 ORDER BY id_produto ASC ';
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="carouselSite">
                                              ...
                                              <input id="quantidade" type="text" name="quantidade" class="form-control" value="1">
                                                ...
                                                <button style="margin-left: 35%;" type="button" class="btn btn-success mt-3" data-toggle="modal" data-target="#exampleModalScrollable<?php echo $produtos['id_produto']?>">
